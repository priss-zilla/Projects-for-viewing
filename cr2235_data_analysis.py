# -*- coding: utf-8 -*-
"""CR2235 Data Analysis

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1aTkqQjqN1wZn6iH7796RyicJ83aNFCiG
"""
...
def load_and_filter_satellite(file_path, start_time, end_time, file_type='auto'):
    ...
    if file_type == 'drivers':
        ...
        # Rename columns to match expected names (based on your original request)
        # You can adjust these names based on what the columns actually represent
...
# =====================================================
# 3️⃣ Interpolate & Smooth MAVEN → AWSoM Time Grid
# =====================================================
def interpolate_and_smooth_maven_to_awsom(maven_df, awsom_times,
    ...
    # === Extra B-field smoothing (as in your original code) ===
...
# =====================================================
# 6️⃣ Plot AWSOM vs MAVEN (Interpolated & Smoothed) - DOUBLED FONTS
# =====================================================
...
# (Section 4.2 of the paper) - 4X FONT SIZE VERSION
# ===========================================================
...
def plot_dtw_histograms(awsom_series, maven_series, path,
    ...
    # Determine text box position for amplitude differences
    # Velocity goes to top right; Density and Bmag to center left; Temperature to center right
...
# If you already have results, generate histograms with 4X fonts
